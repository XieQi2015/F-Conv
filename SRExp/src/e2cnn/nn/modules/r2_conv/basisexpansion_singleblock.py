...
class SingleBlockBasisExpansion(BasisExpansion):
    ...
    def __init__(self,
        ...
        sampled_basis = torch.Tensor(basis.sample(points)).permute(2, 0, 1, 3)# 这里可以把basis输出来看啦。
...
#        print(sampled_basis)
    ...
    def forward(self, weights: torch.Tensor) -> torch.Tensor:
        ...
        return torch.einsum('boi...,kb->koi...', self.sampled_basis, weights) #.transpose(1, 2).contiguous() #这是内积，这里不太需要改，
